...
# Set Frontend to Development Mode (Docker Backend)

echo "🔧 Setting frontend to DEVELOPMENT mode..."
echo ""
...
module.exports = {
  ...
  FORCE_ENV: 'development', // Options: 'auto', 'development', 'production'
...
echo "✅ Frontend set to DEVELOPMENT mode"
echo ""
