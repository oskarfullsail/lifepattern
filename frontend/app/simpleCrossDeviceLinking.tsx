...
type SimpleCrossDeviceLinkingScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'SimpleCrossDeviceLinking'>;

interface Props {
  navigation: SimpleCrossDeviceLinkingScreenNavigationProp;
}
...
export default function SimpleCrossDeviceLinking({ navigation }: Props) {
  ...
  const renderQRCode = () => {
    ...
    return (
      <View style={styles.qrContainer}>
        <Text style={styles.qrTitle}>QR Code Data</Text>
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <Text style={styles.title}>Simple Cross-Device Linking</Text>
